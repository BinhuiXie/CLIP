...
datasets = {
    'visda':  # 6, 3, 3
        {
            ...
            'target_classes': ['aeroplane', 'bicycle', 'bus', 'car', 'horse', 'knife', 'skateboard', 'train', 'truck'],
    ...
    'office31':  # 10, 11, 10
        {
            'source_classes': ['back_pack', 'bike', 'bike_helmet', 'bookcase', 'bottle', 'calculator', 'desk_chair',
                               'desk_lamp', 'desktop_computer', 'file_cabinet', 'headphones', 'keyboard',
                               'laptop_computer', 'letter_tray', 'mobile_phone', 'monitor', 'mouse', 'mug',
                               'paper_notebook', 'pen', 'phone'],
            'target_classes': ['back_pack', 'bike', 'bike_helmet', 'bookcase', 'bottle', 'calculator', 'desk_chair',
                               'desk_lamp', 'desktop_computer', 'file_cabinet', 'headphones', 'printer', 'projector',
                               'punchers', 'ring_binder', 'ruler', 'scissors', 'speaker', 'stapler', 'tape_dispenser',
                               'trash_can'],
    ...
    'home':  # 10, 5, 50
        {
            'source_classes': ['Alarm_Clock', 'Backpack', 'Batteries', 'Bed', 'Bike', 'Bottle', 'Bucket', 'Calculator',
                               'Calendar', 'Candles', 'Chair', 'Clipboards', 'Computer', 'Couch', 'Curtains'],
            'target_classes': ['Alarm_Clock', 'Backpack', 'Batteries', 'Bed', 'Bike', 'Bottle', 'Bucket', 'Calculator',
                               'Calendar', 'Candles', 'Desk_Lamp', 'Drill', 'Eraser', 'Exit_Sign', 'Fan',
                               'File_Cabinet',
                               'Flipflops', 'Flowers', 'Folder', 'Fork', 'Glasses', 'Hammer', 'Helmet', 'Kettle',
                               'Keyboard', 'Knives', 'Lamp_Shade', 'Laptop', 'Marker', 'Monitor', 'Mop', 'Mouse', 'Mug',
                               'Notebook', 'Oven', 'Pan', 'Paper_Clip', 'Pen', 'Pencil', 'Postit_Notes', 'Printer',
    ...
    'domainnet':  # 150, 50, 145
        {
            'source_classes': ['aircraft_carrier',
                               'airplane',
                               'alarm_clock',
                               'ambulance',
                               'angel',
                               ...
                               'nose',
                               'ocean'],
            'target_classes': ['aircraft_carrier',
                               'airplane',
                               'alarm_clock',
                               'ambulance',
                               'angel',
            ...
            'classes': ['aircraft_carrier', 'airplane', 'alarm_clock', 'ambulance', 'angel', 'animal_migration', 'ant',
                        'anvil', 'apple', 'arm', 'asparagus', 'axe', 'backpack', 'banana', 'bandage', 'barn',
                        'baseball',
                        ...
                        'carrot', 'castle', 'cat', 'ceiling_fan', 'cell_phone', 'cello', 'chair', 'chandelier',
                        'church',
        ...
        for domain_name in datasets[dataset_name]['domains']:
            ...
            for model_name in clip.available_models():
                ...
                if dataset_name == 'domainnet':
                    images = ImageList(
                        open(os.path.join('../data', dataset_name, domain_name + '_test.txt')).readlines(),
                ...
                for cls in range(len(dataset_classes)):
                    ...
                    if not (datasets[dataset_name]['split'][0] <= cls < datasets[dataset_name]['split'][0] +
                        ...
                        index = cls if cls < datasets[dataset_name]['split'][0] else cls - \
